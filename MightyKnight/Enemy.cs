...
namespace MightyKnight
{
    class Enemy
    {
        ...
        // keep a reference ot the Game object to check for collisions on the map
        Game1 game = null;
        ...
        public void Load(ContentManager content)
        {
            ...
            animation.Load(content, "sprites/zombieWalk", 10, 12);
        ...
        public void Update(float deltaTime)
        {
            ...
            else
            {
                ...
                bool ny = (Position.Y) % Game1.tile != 0; // zombie overlaps right?
